...
export default function Produto(props) {
    ...
    function addProduct(produto) {
        ...
        if (!props.carrinho.length || !props.carrinho.some((aux) => {
            return aux.id === produto.id
        })) {
            const novoCarrinho = [...props.carrinho, produtoComQuantidade];
        ...
        <div style={{
            ...
            <div id='botao-comprar'>
                <button
                    ...
                    type='button' onClick={() => { addProduct(props.produto) }}>
                    Comprar
                </button>
            </div>
        </div>
